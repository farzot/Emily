    ...
    >
      ...
      <div class="flex gap-10 items-center">
        ...
        > -->
          ...
          <router-link class="[&.router-link-active]:text-white hidden md:block hover-underline-animation font-medium text-[16px] text-[#aaa]" to="/home">Home</router-link>
          <router-link class="[&.router-link-active]:text-white hidden md:block hover-underline-animation font-medium text-[16px] text-[#aaa]" to="/about">About</router-link>
          <router-link class="[&.router-link-active]:text-white hidden md:block hover-underline-animation font-medium text-[16px] text-[#aaa]" to="/products">Products</router-link>
          <router-link class="[&.router-link-active]:text-white hidden md:block hover-underline-animation font-medium text-[16px] text-[#aaa]" to="/posts">Posts</router-link>
          <router-link class="[&.router-link-active]:text-white hidden md:block hover-underline-animation font-medium text-[16px] text-[#aaa]" to="/composable">composable</router-link>
        ...
        <!-- <div class="md:hidden">
          <button
            id="hamburger"
            @click="hamburger()"
            class="flex justify-center items-center text-4xl text-white"
          >
            <svg
